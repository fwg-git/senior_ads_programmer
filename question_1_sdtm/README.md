...
Develop an R program (`01_create_ds_domain.R`) to create the DS domain using the below:

-   Input raw data: `pharmaverseraw::ds_raw`
-   Study controlled terminology [file](https://github.com/pharmaverse/examples/blob/main/metadata/sdtm_ct.csv)
-   [Mock-up](https://github.com/pharmaverse/pharmaverseraw/blob/main/vignettes/articles/aCRFs/Subject_Disposition_aCRF.pdf) *Note: there might be misspellings*
